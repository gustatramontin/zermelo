...
class  ZermeloParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleSet = 0, RuleAssignment = 1, RuleMembership = 2, RuleSubset = 3, 
    RuleProgram = 4
  };

  explicit ZermeloParser(antlr4::TokenStream *input);

  ZermeloParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~ZermeloParser() override;
  ...
  public:
    ...
    std::vector<SubsetContext *> subset();
    SubsetContext* subset(size_t i);
